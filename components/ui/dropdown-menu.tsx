...
/**
 * Menu suspenso de acoes. Use para ACAO ("copiar link da ficha",
 * "baixar os dados"). Para escolher um valor de formulario, use Select:
 * ele tem semantica de campo e entra no envio da pagina.
 */
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(classesPainel, className)}
        {...props}
      />
    </DropdownMenuPrimitive.Portal>
  );
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(classesItem, className)}
      {...props}
    />
  );
}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(classesItem, "data-[state=open]:bg-papel", className)}
      {...props}
    >
      {children}
